-- Script to export observations counts by administrators
-- Usage (from local computer): cat ./observations_count_by_administrators.sql | ssh geonat@db-paca-sinp 'export PGPASSWORD="<db-user-pwd>" ; psql -q -h localhost -p 5432 -U gnreader -d geonature2db' > ./$(date +'%F')_obs_by_administrators.csv
