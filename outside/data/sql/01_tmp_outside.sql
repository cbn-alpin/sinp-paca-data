-- Compute observations with corresponding area
BEGIN;
...
-- Compute observations with no M10 corresponding area
BEGIN;
...
-- Compute observations with no M5 corresponding area
BEGIN;
...
-- Compute observations with no M1 corresponding area
BEGIN;
...
-- Compute observations with no Communes corresponding area
BEGIN;
...
-- Compute observations with no Départements corresponding area
BEGIN;
...
-- Compute observations with no PACA Départements corresponding area
BEGIN;
...
-- Compute observations outside SINP PACA territory
BEGIN;
