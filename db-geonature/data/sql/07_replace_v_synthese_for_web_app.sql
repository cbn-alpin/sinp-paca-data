...
--      add forgotten fields id_nomenclature_biogeo_status and cd_hab
-- Required rights: DB OWNER
-- Transfert this script on server this way:
-- rsync -av ./07_* geonat@db-aura-sinp:~/data/db-geonature/data/sql/ --dry-run
-- Use this script this way: psql -h localhost -U geonatadmin -d geonature2db -f ~/data/db-geonature/data/sql/07_*
