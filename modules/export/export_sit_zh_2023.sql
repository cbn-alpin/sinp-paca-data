...
DROP MATERIALIZED VIEW IF EXISTS gn_exports.sit_zh_taxon_2023;

CREATE MATERIALIZED VIEW gn_exports.sit_zh_taxon_2023 AS
WITH
    ...
    nationally_protected_observations_in_wetlands AS (
        SELECT DISTINCT
            ...
            z.code,
            z.main_name
        FROM ref_geo.sit_zones_humides_2023 AS z
...
ORDER BY code_zh, nom_valide DESC
WITH DATA;

CREATE UNIQUE INDEX sit_zh_taxon_2023_pk ON gn_exports.sit_zh_taxon_2023 USING btree (code_zh, cd_ref);

CREATE INDEX sit_zh_taxon_2023_cd_ref_idx ON gn_exports.sit_zh_taxon_2023 USING btree (cd_ref);
