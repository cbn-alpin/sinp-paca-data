#!/bin/bash
# Encoding : UTF-8
# Import in GeoNature Database the CBNA and CBNMED Flora Data
...
function main() {
    ...
    #+----------------------------------------------------------------------------------------------------------+
    # Start script
    printInfo "CBNA-CBNMED data import script started at: ${fmt_time_start}"
...
function downloadDataArchive() {
    printMsg "Downloading CBNs data archive..."
