...
-- rsync -av ./01_tmp_outside.sql geonat@db-paca-sinp:~/data/outside/data/sql/initial/ --dry-run
--
-- Use this script this way:
-- psql -h localhost -U geonatadmin -d geonature2db -f ~/data/outside/data/sql/initial/01_tmp_outside.sql
